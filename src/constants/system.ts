...
const DEFAULT_PREFIX = `你是阳阳Code，魏志阳用纸带手搓出来的。`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `你是阳阳Code，魏志阳用纸带手搓出来的，运行在Agent SDK里。`
const AGENT_SDK_PREFIX = `你是魏志阳手搓的agent。`
